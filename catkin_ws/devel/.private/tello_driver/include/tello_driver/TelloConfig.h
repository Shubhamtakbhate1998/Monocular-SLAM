...
namespace tello_driver
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(TelloConfig &config, const TelloConfig &max, const TelloConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const TelloConfig &config1, const TelloConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, TelloConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const TelloConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, TelloConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const TelloConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const TelloConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, TelloConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(TelloConfig::AbstractParamDescriptionConstPtr(new TelloConfig::ParamDescription<int>("fixed_video_rate", "int", 0, "Video rate", "{'enum': [{'name': 'Auto', 'type': 'int', 'value': 0, 'srcline': 9, 'srcfile': '/home/shubh/catkin_ws/src/tello_driver/cfg/Tello.cfg', 'description': 'Let drone automatically decide', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': '1p0Mbps', 'type': 'int', 'value': 1, 'srcline': 10, 'srcfile': '/home/shubh/catkin_ws/src/tello_driver/cfg/Tello.cfg', 'description': 'Set to 1.0Mb/s fixed rate (~4.5KB/frame @ 30fps)', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': '1p5Mbps', 'type': 'int', 'value': 2, 'srcline': 11, 'srcfile': '/home/shubh/catkin_ws/src/tello_driver/cfg/Tello.cfg', 'description': 'Set to 1.5Mb/s fixed rate (~6.6KB/frame @ 30fps)', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': '2p0Mbps', 'type': 'int', 'value': 3, 'srcline': 12, 'srcfile': '/home/shubh/catkin_ws/src/tello_driver/cfg/Tello.cfg', 'description': 'Set to 2.0Mb/s fixed rate (~8.5KB/frame @ 30fps)', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': '2p5Mbps', 'type': 'int', 'value': 4, 'srcline': 13, 'srcfile': '/home/shubh/catkin_ws/src/tello_driver/cfg/Tello.cfg', 'description': 'Set to 2.5Mb/s fixed rate ( ~11KB/frame @ 30fps)', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Video rate options'}", &TelloConfig::fixed_video_rate)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 9 "/home/shubh/catkin_ws/src/tello_driver/cfg/Tello.cfg"
      const int Tello_Auto = 0;
//#line 10 "/home/shubh/catkin_ws/src/tello_driver/cfg/Tello.cfg"
      const int Tello_1p0Mbps = 1;
//#line 11 "/home/shubh/catkin_ws/src/tello_driver/cfg/Tello.cfg"
      const int Tello_1p5Mbps = 2;
//#line 12 "/home/shubh/catkin_ws/src/tello_driver/cfg/Tello.cfg"
      const int Tello_2p0Mbps = 3;
//#line 13 "/home/shubh/catkin_ws/src/tello_driver/cfg/Tello.cfg"
